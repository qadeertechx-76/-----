...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 QADEER-KD-MINI\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("OLD-STUDIO MD")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029VbCT0WnFsn0cPZKRDu3V*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 :𝗤𝗮𝗱𝗲𝗲𝗿-𝗞𝗗-𝗺𝗶𝗻𝗶")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://eliteprotech-url.zone.id/17811544125180mgf6u.jpg' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT Qadeer-KD-mini", 'utf-8') }]
                            });
